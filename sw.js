const CACHE = 'goggicantiere-v6-category-blackfix';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./storage.js','./priceLists.js','./articles.json','./manifest.webmanifest','./logo.png','./logo-full.png','./logo-monogram.png'];
