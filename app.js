(function(){
  ...
  function openOffer(offer){ current = JSON.parse(JSON.stringify(offer)); articleListOpen = false; show('editView'); populateForm(); recalc(); renderItems(); refreshPriceLists(); $('articleSearch').value=''; $('searchResults').innerHTML=''; setTimeout(()=> $('articleSearch').focus(), 150); }
  ...
  function renderSearch(){
    ...
    found = sortArticles(found, $('articleSort')?.value || 'nr');
    const limit = showAll ? 5000 : 80;
